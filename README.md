# Forger Family Intelligence Dossier

> **Vibe Focus:** Mid-Century Modern / Secret Agent Dossier Aesthetic  
> **Tech Stack:** Static HTML/JS + Tailwind CSS 4.0 + Python Generators

Welcome to the **Forger Family Intelligence Dossier** web portal. This is a high-performance, immersive manga reader site designed specifically for fans of the series. The project leverages modern web optimization techniques to deliver a fast, localized, and beautiful experience.

---

## 🌟 Key Features

- Manila folder cards and classified rubber-stamp overlay designs.
- Classified mission summaries with hidden easter egg files.
- Scroll navigation tracking using Intersection Observer.
- Clean URLs layout removing trailing HTML extensions.
...
Serve the intelligence logs locally:
```bash
...
- **`python deploy_intel_reports.py`**: Generates classified mission analysis briefings.
- **`python generate_legal_pages.py`**: Builds sanitized legal privacy guidelines.
...
Fully static site. Deploy root folder files to any CDN or server.
